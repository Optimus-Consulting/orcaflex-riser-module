...
export type UndoableAction =
  | { type: 'UPDATE_ENVIRONMENT'; previous: EnvironmentConfig; current: EnvironmentConfig }
  | { type: 'ADD_VESSEL'; vessel: VesselConfig }
  | { type: 'UPDATE_VESSEL'; previous: VesselConfig; current: VesselConfig }
  | { type: 'DELETE_VESSEL'; vessel: VesselConfig }
  | { type: 'ADD_LINE_TYPE'; lineType: LineTypeConfig }
  | { type: 'UPDATE_LINE_TYPE'; previous: LineTypeConfig; current: LineTypeConfig }
  | { type: 'DELETE_LINE_TYPE'; lineType: LineTypeConfig }
  | { type: 'ADD_RISER'; riser: RiserConfig }
  | { type: 'UPDATE_RISER'; previous: RiserConfig; current: RiserConfig }
  | { type: 'DELETE_RISER'; riser: RiserConfig };
